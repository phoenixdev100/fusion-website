                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-black/20 rounded-2xl">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`h-2 w-2 rounded-full ${duelsStats.online ? 'bg-green-500' : 'bg-red-500'}`}></span>
                          <span>{duelsStats.online ? 'Online' : 'Offline'}</span>
                        </div>
                                </div>
                      <div className="flex items-center justify-between p-4 bg-black/20 rounded-2xl">
                      ...
                      <div className="flex items-center justify-between p-4 bg-black/20 rounded-2xl">
                        ...
                        <span>{duelsStats.performance.tps.toFixed(1)} TPS</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    {duelsStats.players.list.length > 0 && (
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                          {duelsStats.players.list.map((player, index) => (
                            <motion.div
